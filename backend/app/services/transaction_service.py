...
class TransactionManager:
    ...
    def _init_db(self):
        ...
        try:
            ...
            self.logger.error(f"Error initializing transaction cache DB: {e}")
    ...
    def _store_running_totals(self, df: pd.DataFrame, user_id: str):
        ...
        try:
            ...
            self.logger.error(f"Error storing running totals: {e}")
    ...
    def get_cached_totals(self, user_id: str, symbol: str, as_of_date: date) -> Optional[Dict]:
        ...
        try:
            ...
            self.logger.error(f"Error retrieving cached totals: {e}")
